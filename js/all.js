...
!(function (e, t) {
  ...
  var t,
    ...
    g = function (e, t) {
      ...
      return (
        ...
        'easeInOutQuart' === e && (n = 0.5 > t ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t),
  ...
  var I = function (t) {
      e.location.hash;
      n &&
        ((n.id = n.getAttribute('data-scroll-id')), c.animateScroll(n, o), (n = null), (o = null));
    },
    S = function (r) {
      if (
        0 === r.button &&
            ...
            function () {
              $pp_pic_holder
                ...
                settings.allow_expand &&
                  (f.resized ? e('a.pp_expand,a.pp_contract').show() : e('a.pp_expand').hide()),
              ...
              switch (
                ...
                case 'vimeo':
                  ...
                  var t = /http(s?):\/\/(www\.)?vimeo.com\/(\d+)/,
                    i = movie_id.match(t);
                  (movie =
                    'http://player.vimeo.com/video/' + i[3] + '?title=0&byline=0&portrait=0'),
                    settings.autoplay && (movie += '&autoplay=1;'),
          ...
          e.each(function () {
            ...
            u.data('stellar-backgroundStartingLeft')
              ...
              i.backgrounds.push({
                ...
                parentOffsetTop: v,
                stellarRatio:
                  u.data('stellar-background-ratio') === s ? 1 : u.data('stellar-background-ratio'),
              });
          }));
    },
    _reset: function () {
            ...
            this.options.hideDistantElements &&
              ...
              (d =
                ...
                (l + t.height > (t.isFixed ? 0 : p) &&
                  l < (t.isFixed ? 0 : p) + this.viewportHeight + this.viewportOffsetTop))),
            u && d
              ? (t.isHidden && (this.options.showElement(t.$element), (t.isHidden = !1)),
                this._setPosition(t.$element, n, t.startingPositionLeft, r, t.startingPositionTop))
    ...
    (i.Isotope.prototype = {
      ...
      _getSegments: function (t) {
        var i,
          ...
          a = this.element[n](),
          h =
            (this.options[s] && this.options[s][e]) || this.$filteredAtoms['outer' + r(n)](!0) || a;
    ...
    (d.prototype = {
          ...
          this.$element.find('option').each(function (b) {
            ...
            if ((h++, !c.hasClass('bs-title-option'))) {
              var g = this.className || '',
                ...
                p =
                  this.disabled ||
                  ('OPTGROUP' === this.parentElement.tagName && this.parentElement.disabled);
                ...
                var e,
                  ...
                  d =
                    b.data('icon') && c.options.showIcon
                      ? '<i class="' + c.options.iconBase + ' ' + b.data('icon') + '"></i> '
                      : '';
                return (
                  (e =
        ...
        if ((t(), this.options.header && c.css('padding-top', 0), 'auto' === this.options.size)) {
          var u = function () {
            ...
            t(),
              (p = s - n),
              b.options.container
                ? (c.data('height') || c.data('height', c.height()), (q = c.data('height')))
                : (q = c.height()),
          ...
          (p = g * this.options.size + w * l + m),
            ...
            c.css({ 'max-height': p + h + i + j + k + 'px', overflow: 'hidden', 'min-height': '' }),
              ...
              g.each(function (b) {
                ...
                d.$lis.not('.hidden, .no-results').length
                  ...
                  : (e.parent().length && e.remove(),
                    e
                      .html(
                        d.options.noneResultsText.replace('{0}', '"' + c(d.$searchbox.val()) + '"'),
                      )
                      .show(),
      ...
      keydown: function (c) {
        ...
        if (
          ...
          if (/(38|40)/.test(c.keyCode.toString(10)))
              ...
              g.options.liveSearch
                ? (c.preventDefault(),
                  d.hasClass('dropdown-toggle') ||
                    (f.removeClass('active').eq(h).addClass('active').children('a').focus(),
                    d.focus()))
                : f.eq(h).focus();
          else if (!d.is('input')) {
            var s,
            ...
            f.each(function () {
              ...
              t != q[c.keyCode]
                ...
                : s >= r.length && (a(document).data('keycount', 0), s > r.length && (s = 1)),
              f.eq(r[s - 1]).focus();
          }
          if (
          ...
          ((/(^9$|27)/.test(c.keyCode.toString(10)) && o && (g.multiple || g.options.liveSearch)) ||
